...
# Carregar branch declarada pelo gestor a partir de config/codigo-fonte-branches.json.
# Se -Branch foi passado explicito, ele tem precedencia (override manual).
if (-not $Branch) {
