...
.DESCRIPTION
  Igual ao script no repositorio General: veja mensagens ao executar.
...
Write-Host ""
Write-Host "Este projeto inclui .cursor/sandbox.json (rede no sandbox + cache partilhado)." -ForegroundColor DarkGray
Write-Host ""
