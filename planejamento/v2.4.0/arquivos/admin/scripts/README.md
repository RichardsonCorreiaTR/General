...
- **Parametros**: Nenhum obrigatorio.
- **Saida esperada**: Pacote em `atualizacao/vX.Y.Z/` com arquivos, VERSION.json e manifesto.
...
- **Parametros**: Nenhum obrigatorio.
- **Saida esperada**: Arquivos MD em `indices/enriquecidos/{modulo}.md`, legiveis pelo Cursor sem risco de OOM.
- **Dependencias**: Dados brutos em `banco-dados/dados-brutos/`.
...
atualizar-tudo.bat
  ...
  |-- importar-sais.ps1
  |-- gerar-indices-sais.ps1
  |-- gerar-indices-enriquecidos.ps1 (v2.4.0)
  |-- reconstruir-cache.ps1
  |-- gerar-atualizacao.ps1
